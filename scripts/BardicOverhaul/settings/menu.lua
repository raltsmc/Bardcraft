...
I.Settings.registerRenderer('BardicOverhaul/inputKeySelection', function(value, set)
...
I.Settings.registerRenderer('BardicOverhaul/betterTextInput', function(value, set, arg)
...
I.Settings.registerGroup {
    key = 'Settings/BardicOverhaul/1_Keybinds',
    page = 'BardicOverhaul',
    l10n = 'BardicOverhaul',
